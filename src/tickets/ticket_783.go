...
type Ticket_783 struct {
	no          uint
	description string
	testcases   []dao.TestCase
}

func (t *Ticket_783) New_testcase(testcase_id uint, testcase_description string) *dao.TestCase {
	return dao.New_testcase(testcase_id, testcase_description)
}

func (t *Ticket_783) Get_no() uint {
	return t.no
}

func (t *Ticket_783) Get_dsctn() string {
	return t.description
}

func (t *Ticket_783) Add_testcase(tc dao.TestCase) {
	t.testcases = append(t.testcases, tc)
}

func (t *Ticket_783) Get_testcases() []dao.TestCase {
	return t.testcases
}

// Enter your ticket information here
func (t *Ticket_783) Set_values() {
	t.no = 783 // Enter your ticket id
	t.description = "Run Jobnet"
}

// Add your test case here
func (t *Ticket_783) Add_testcases() {
