...
func (t *Ticket_968) New_testcase(testcase_id uint, testcase_description string) *common.TestCase {
...
func (t *Ticket_968) Add_testcase(tc common.TestCase) {
	t.Testcases = append(t.Testcases, tc)
}

func (t *Ticket_968) Get_testcases() []common.TestCase {
	return t.Testcases
}
...
func (t *Ticket_968) logError(tc_97 *common.TestCase, format string, args ...interface{}) common.Testcase_status {
	fmt.Println(lib.Logi(common.LOG_LEVEL_ERR, format, args...))
	return FAILED
}

// check for the presence of 10 lock files
func (t *Ticket_968) CheckDBconCount(tc_97 *common.TestCase) common.Testcase_status {
...
func (t *Ticket_968) executeJob(job string, envs map[string]string, tc_97 *common.TestCase) (string, common.Testcase_status) {
...
func (t *Ticket_968) runAgentless100(tc_97 *common.TestCase) common.Testcase_status {
	envs, err := t.setupEnv()
	if err != nil {
...
func (t *Ticket_968) runAgentless(tc_98 *common.TestCase) common.Testcase_status {
...
func (t *Ticket_968) runAgentless2(tc_98 *common.TestCase) common.Testcase_status {
	envs, err := t.setupEnv2()
	if err != nil {
		return t.logError(tc_98, "Error getting environment variables: %s", err)
	}
...
func (t *Ticket_968) deleteLockFiles(tc_98 *common.TestCase) common.Testcase_status {
...
func (t *Ticket_968) deleteLockFiles2(tc_99 *common.TestCase) common.Testcase_status {
	cmd := "rm -rf /var/log/jobarranger/session_dbc_locks/" // Delete all files in the folder
	_, err := lib.Ssh_exec(cmd)
	if err != nil {
...
func (t *Ticket_968) checkLog(tc_98 *common.TestCase) common.Testcase_status {
...
func (t *Ticket_968) checkJobStatus(runJobnetID string, tc_97 *common.TestCase) common.Testcase_status {
